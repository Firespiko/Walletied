            ...
            <CardContent className="space-y-8 px-8 pb-8">
              <div className="space-y-3">
                ...
                <Input
                  ...
                  className="bg-white/10 border-blue-400/30 text-white placeholder:text-white/60 font-mono h-14 text-lg px-6"
                />
              </div>
              ...
              <button 
                ...
                className="crypto-button w-full h-14 bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-700 hover:to-cyan-600 disabled:opacity-50 shadow-lg shadow-blue-500/25 px-6 rounded text-white font-mono text-lg font-medium"
                style={{ color: '#06b6d4' }}
              >
                Create Wallet
              </button>
